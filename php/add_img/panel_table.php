...
<body>
    <nav>
        <ul class= "menu">
            ...
            <li><a href="panel_control.php">VOLTAR</a></li>
        </ul>
    </nav>
    <div class="container">
   ...
   if(isset($_POST['delete_id'])) { // verifica se o formulário de exclusão foi submetido
       ...
       if ($conexao->query($sql_delete) === TRUE) {
           ...
           header('Location: painel_table.php');
    ...
    $sql = "SELECT id, nome, imagem FROM $texto ORDER BY id DESC LIMIT 1";
       ...
       <tbody>
           ...
           echo "<tr>
                   ...
                   <div class='button-container'>
                       <form method='POST' action='panel_alter.php'>
                       ...
                       <form method='POST' action='panel_consult.php'>
