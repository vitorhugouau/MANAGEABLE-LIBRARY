...
<?php
    ...
    if(isset($_POST['delete_id'])) { // verifica se o formulário de exclusão foi submetido
        ...
        $sql_delete = "DELETE FROM equipamentos WHERE id_equipamento = $id";
        // executa a query 
...
<!---------------------------------------BOTAO PARA VOLTAR------------------------------------------------------->
    <nav>
        <ul class= "menu">
            ...
            <li><a href="add_equipamento.php">ADICIONAR EQUIPAMENTO</a></li>
            ...
            while ($dados = $resultado->fetch_assoc()) {
                ...
                <td>  
                            ...
                            <div class='button-container'>
                                <input type='hidden' name='delete_id' value='". $dados["id_equipamento"] ."'> 
                                <button type='submit' onclick='return confirmarExclusao()' class='btn btn-danger'>EXCLUIR</button>
                                </div>
                            </form>
                            <form method='POST' action='edit_equipamento.php'>
                                <input type='hidden' name='edit' value='". $dados["id_equipamento"] ."'>
